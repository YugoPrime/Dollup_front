...
export function Lightbox({
  ...
  // Arrow-key navigation. Escape is handled by FocusTrapLayer's escapeDeactivates.
  useEffect(() => {
  ...
  return (
    <FocusTrapLayer
      ariaLabel={current.alt || "Product image viewer"}
    ...
    >
      ...
      <div className="relative z-[1] h-[88vh] w-[92vw] max-w-[1100px]">
        <Image
          src={current.url}
          alt={current.alt ?? ""}
          fill
      ...
      {images.length > 1 && (
        <div className="absolute bottom-5 left-1/2 z-10 -translate-x-1/2 rounded-full bg-white/15 px-4 py-1.5 font-sans text-[12px] font-semibold text-white">
