    ...
    <div className="bg-cream">
      ...
      <section className="bg-gradient-to-br from-[#FCE9E4] via-[#F8D5CD] to-[#F8B0A0] px-6 py-14 md:px-10 md:py-20">
        <div className="mx-auto max-w-[900px] text-center">
          ...
          <p className="mx-auto mt-5 max-w-[520px] font-sans text-[14px] leading-[1.55] text-ink-soft md:text-[15px]">
            Question about a product, sizing, or your order? The fastest way to reach us is WhatsApp — we reply within a few hours, Monday to Friday.
          </p>
        </div>
      </section>
      ...
      <section className="px-6 py-12 md:px-10 md:py-16">
        <div className="mx-auto max-w-[800px] rounded-2xl bg-white p-8 text-center shadow-[0_2px_8px_rgba(229,96,74,0.05)] md:p-12">
          ...
          <p className="mx-auto mt-3 max-w-[480px] font-sans text-[13px] leading-[1.55] text-ink-soft md:text-[14px]">
            Sizing, delivery, returns, payment — chances are we&apos;ve already answered it. Have a quick look first, it&apos;s the fastest way.
          </p>
